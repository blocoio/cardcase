...
public class Theme {
  ...
  public static void applyThemeFor(View view, Context ctx) {
    ...
    for (Button butt : getViewsFromViewGroup(view.findViewById(android.R.id.content),
        Button.class)) {
      butt.setBackgroundColor(accentColor);
      butt.setTextColor(textIconColor);
    }

    for (FloatingActionButton butt : getViewsFromViewGroup(view.findViewById(android.R.id.content),
        FloatingActionButton.class)) {
      butt.setBackgroundColor(accentColor);
      butt.setBackgroundTintList(ColorStateList.valueOf(accentColor));
    }

    for (Toolbar toolbar : getViewsFromViewGroup(view.findViewById(android.R.id.content),
        Toolbar.class)) {
    ...
    // All text fields
    for (EditText editText : getViewsFromViewGroup(view.findViewById(android.R.id.content),
        EditText.class)) {
    ...
    for (EditText editText : getViewsFromViewGroup(view.findViewById(R.id.user_card),
        EditText.class)) {
    ...
    for (EditText editText : getViewsFromViewGroup(view.findViewById(R.id.home_categories),
        EditText.class)) {
      editText.setBackgroundColor(textIconColor);
      editText.getBackground().setColorFilter(textIconColor, PorterDuff.Mode.SRC_ATOP);
    }
    ...
    // Text fields on Category
    for (Button buttonExchange : getViewsFromViewGroup(view.findViewById(R.id.exchange_container),
        Button.class)) {
      buttonExchange.setBackgroundColor(currentBackgroundColor);
      buttonExchange.getBackground()
          .setColorFilter(currentBackgroundColor, PorterDuff.Mode.SRC_ATOP);
    }
