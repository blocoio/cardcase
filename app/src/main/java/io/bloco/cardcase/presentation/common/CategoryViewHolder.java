...
public class CategoryViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
  ...
  @Bind(R.id.name_text_edit) MyEditText nameEditText;
  ...
  @Inject public CategoryViewHolder(View view, HomeContract.View homeContract, Database database) {
    super(view);
  ...
  @OnTextChanged(R.id.name_text_edit) public void afterTextChanged(CharSequence text) {
  ...
  private View.OnCreateContextMenuListener onCreateContextListener =
  ...
  @Subscribe(threadMode = ThreadMode.MAIN) public void onMessageEvent(DoneClickedEvent event) {
    nameEditText.deactivate();
    nameEditText.setVisibility(View.GONE);
    nameTextView.setVisibility(View.VISIBLE);
    nameTextView.setText(nameEditText.getText());
