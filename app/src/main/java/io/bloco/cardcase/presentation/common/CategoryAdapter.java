...
@PerActivity public class CategoryAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
  ...
  @Inject public CategoryAdapter(Activity activity, Database database) {
  ...
  @Override public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    switch (viewType) {
      case ViewType.FOOTER:
        view =
            LayoutInflater.from(parent.getContext()).inflate(R.layout.add_category, parent, false);
