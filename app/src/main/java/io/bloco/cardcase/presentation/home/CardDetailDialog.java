...
@PerActivity public class CardDetailDialog implements AdapterView.OnItemSelectedListener {
  ...
  @Bind(R.id.card_detail_dialog_id) View overlay;
  @Bind(R.id.card_dialog_info) CardInfoView cardInfoView;
  @Bind(R.id.card_dialog_toolbar) LinearLayout dialogToolbar;
  @Bind(R.id.card_dialog_delete) ImageButton deleteCard;
  @Bind(R.id.card_dialog_share) ImageButton shareCard;
  @Bind(R.id.card_dialog_transition_overlay) View transitionOverlay;
  @Bind(R.id.card_dialog_category_spinner) Spinner spinner;

  // TODO: Inject only the activity context?
  @Inject public CardDetailDialog(Activity activity, Database database) {
  ...
  @OnClick(R.id.card_dialog_delete) public void onClickedDelete() {
  ...
  private void setSpinnerValues() {
    ...
    ArrayAdapter<String> adapter =
        new ArrayAdapter<>(this.getDialog().getContext(), android.R.layout.simple_spinner_item,
            categoriesNames);
    ...
    spinner.setSelection(adapter.getPosition(
        database.getCategory(cardInfoView.getCard().getCategoryId()).getName()));
  }
  ...
  @OnClick(R.id.card_dialog_share) public void onClickedShare() {
